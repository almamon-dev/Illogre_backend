...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="heading">Invitation to join the team on Tixolve.</div>

            <div class="text">Hi {{ $name }},</div>

            <div class="text">
                This email confirms that you've been invited to join the team on Tixolve as a <strong>{{ $role }}</strong>. 
            ...
            <div style="background: #f9f9f9; padding: 20px; border-radius: 8px; margin-bottom: 25px; border: 1px solid #eeeeee;">
                <div class="text" style="font-size: 14px; margin-bottom: 5px; color: #666;">Once activated, use these credentials:</div>
                <div class="text" style="margin-bottom: 10px;"><strong>Email:</strong> {{ $email ?? 'Your email' }}</div>
                <div class="text" style="margin-bottom: 0;"><strong>Temporary Password:</strong> {{ $password }}</div>
            </div>
